...
(defun (setf cls-concretep) (cls v)
...
(defun (setf cls-constraints) (cls vs)
...
(defun (setf slot-documentation) (slot v)
...
(defun (setf slot-value-type) (slot val)
...
(defun (setf slot-minimum-cardinality) (slot v)
...
(defun (setf slot-maximum-cardinality) (slot v)
...
(defun (setf slot-minimum-value) (slot v)
...
(defun (setf slot-maximum-value) (slot v)
...
(defun (setf slot-defaults) (slot vs)
...
(defun (setf slot-values) (slot vs)
...
(defun (setf slot-inverse-slot) (slot v)
...
(defun (setf slot-allowed-clses) (slot vs)
...
(defun (setf slot-allowed-parents) (slot vs)
  (setf (frame-own-slot-values slot PROTEGE-KB:|:SLOT-VALUE-TYPE|)
...
(defun (setf slot-allowed-values) (slot vs)
  (setf (frame-own-slot-values slot PROTEGE-KB:|:SLOT-VALUE-TYPE|)
...
(defun (setf facet-documentation) (facet v)
...
(defun (setf facet-associated-slot) (facet v)
