...
(mlcl-kb:def-kb "PROTEGE-KB")

(mlcl-kb:in-kb "PROTEGE-KB")
...
(mlcl-kb:def-cls ":THING" :types |:STANDARD-CLASS|
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| abstract-value)))
(mlcl-kb:def-cls ":SYSTEM-CLASS" :types |:STANDARD-CLASS| :superclses |:THING|
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| abstract-value)))
(mlcl-kb:def-cls ":META-CLASS" :types |:STANDARD-CLASS| :superclses |:SYSTEM-CLASS| 
                       :template-slots (cl:list |:NAME| |:DIRECT-TYPE|)
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| abstract-value)))
(mlcl-kb:def-cls ":CLASS" :types |:STANDARD-CLASS| :superclses |:META-CLASS|
                       :template-slots (cl:list |:DIRECT-INSTANCES| |:DIRECT-SUBCLASSES| |:DIRECT-SUPERCLASSES| |:DIRECT-TEMPLATE-SLOTS|)
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| abstract-value)))
(mlcl-kb:def-cls ":STANDARD-CLASS" :types |:STANDARD-CLASS| :superclses |:CLASS|
                       :template-slots (cl:list |:DOCUMENTATION| |:ROLE| |:SLOT-CONSTRAINTS|)
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| concrete-value)))
(mlcl-kb:def-cls ":SLOT" :types |:STANDARD-CLASS| :superclses |:META-CLASS|
                       :template-slots (cl:list |:DIRECT-DOMAIN| |:SLOT-VALUE-TYPE|)
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| abstract-value)))
(mlcl-kb:def-cls ":STANDARD-SLOT" :types |:STANDARD-CLASS| :superclses |:SLOT|
                       :template-slots (cl:list |:ASSOCIATED-FACET| |:DIRECT-SUBSLOTS| |:DIRECT-SUPERSLOTS| |:DOCUMENTATION| 
                                                ...
                                                |:SLOT-VALUES|)
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| concrete-value)))
(mlcl-kb:def-cls ":FACET" :types |:STANDARD-CLASS| :superclses |:META-CLASS|
                       :template-slots (cl:list |:ASSOCIATED-SLOT| |:DOCUMENTATION|)
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| abstract-value)))
(mlcl-kb:def-cls ":STANDARD-FACET" :types |:STANDARD-CLASS| :superclses |:FACET|
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| concrete-value)))
(mlcl-kb:def-cls ":CONSTRAINT" :types |:STANDARD-CLASS| :superclses |:SYSTEM-CLASS|
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| abstract-value)))
(mlcl-kb:def-cls ":PAL-CONSTRAINT" :types |:STANDARD-CLASS| :superclses |:CONSTRAINT|
                       :template-slots (cl:list |:PAL-DESCRIPTION| |:PAL-NAME| |:PAL-RANGE| |:PAL-STATEMENT|)
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| concrete-value)))
(mlcl-kb:def-cls ":ANNOTATION" :types |:STANDARD-CLASS| :superclses |:SYSTEM-CLASS|
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| abstract-value)))
(mlcl-kb:def-cls ":INSTANCE-ANNOTATION" :types |:STANDARD-CLASS| :superclses |:ANNOTATION|
                       :template-slots (cl:list |:ANNOTATED-INSTANCE| |:ANNOTATION-TEXT| |:CREATION-TIMESTAMP| |:CREATOR|)
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| concrete-value)))
(mlcl-kb:def-cls ":RELATION" :types |:STANDARD-CLASS| :superclses |:SYSTEM-CLASS|
                       :own-slot-values-list (cl:list (cl:cons |:ROLE| abstract-value)))
(mlcl-kb:def-cls ":DIRECTED-BINARY-RELATION" :types |:STANDARD-CLASS| :superclses |:RELATION|
...
(mlcl-kb:def-slot ":ASSOCIATED-FACET" :types |:STANDARD-SLOT|
                        :own-slot-values-list (cl:list (cl:cons |:SLOT-INVERSE| |:ASSOCIATED-SLOT|)
                                                       (cl:cons |:SLOT-VALUE-TYPE| (cl:list  instance-type-value |:FACET|))))
(mlcl-kb:def-slot ":ASSOCIATED-SLOT" :types |:STANDARD-SLOT|
                        :own-slot-values-list (cl:list (cl:cons |:SLOT-INVERSE| |:ASSOCIATED-FACET|)
...
(mlcl-kb:def-slot ":DIRECT-DOMAIN" :types |:STANDARD-SLOT|
                        :own-slot-values-list (cl:list (cl:cons |:SLOT-INVERSE| |:DIRECT-TEMPLATE-SLOTS|)
                                                       (cl:cons |:SLOT-VALUE-TYPE| (cl:list instance-type-value |:CLASS|))))
(mlcl-kb:def-slot ":DIRECT-INSTANCES" :types |:STANDARD-SLOT|
                        :own-slot-values-list (cl:list (cl:cons |:SLOT-INVERSE| |:DIRECT-TYPE|)
                                                       (cl:cons |:SLOT-VALUE-TYPE| (cl:list instance-type-value |:THING|))))
...
(mlcl-kb:def-slot ":SLOT-CONSTRAINTS" :types |:STANDARD-SLOT|
                        :own-slot-values-list (cl:list (cl:cons |:SLOT-VALUE-TYPE| (cl:list instance-type-value |:CONSTRAINT|))))
